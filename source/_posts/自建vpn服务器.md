...
- 兴趣爱好
- 其他
cover: https://ws1.sinaimg.cn/large/466f79e8ly1fw5oh8lh33j218g0p011c.jpg
date: 2019-11-24 20:52:03
---

# VPN简介
天朝有时候还是需要去外面看一下的.虽然身体不允许[没钱,哈哈],但是心里偶尔还是可以的.
本文主要是介绍如何简单的自己搭建一个梯子.

# 准备环境
服务器:
服务器是有要求的,链接服务器后,需要ping google能够ping通,才可以的.
所以,VPN实际的作用,就是墙内电脑通过VPN做代理,让自己在处于墙外进行信息获取.所以,作为代理的服务器,一定是需要能够链接到墙外的.
服务器主要是安装代理服务端.
* 阿里云 海外节点.
* vultr
* pussr.net 
...
电脑:
* ShadowsocksR 
相关软件下载链接: [SSR工具](https://ssr.tools/428)


# 搭建vpn
参考: [搭建VPN](https://github.com/Alvin9999/new-pac/wiki/%E8%87%AA%E5%BB%BAss%E6%9C%8D%E5%8A%A1%E5%99%A8%E6%95%99%E7%A8%8B)
...
# Docker 安装SSR
已经制作好了镜像,直接下载镜像即可运行ssr

[Docker搭建SSR](https://github.com/cynen/linux-scripts/tree/master/ssr_dockerfile)
这里可能比较繁琐,需要自己构建一个镜像.
实际镜像可以通过一下命令直接获取:
```
docker pull cynen/alpinessr:1.1 
```
默认是: 8380端口
密码是: 666666
